...
public class FocusSquare : MonoBehaviour
{
	...
	void Update ()
	{
		if (Input.touchCount > 0 && SquareState == FocusState.Found) {
			ground.transform.position = foundSquare.transform.position;
			GameObject pokemon = Instantiate (pokemonPrefab, new Vector3 (0, foundSquare.transform.position.y + 3, 2.5f), pokemonPrefab.transform.rotation);
